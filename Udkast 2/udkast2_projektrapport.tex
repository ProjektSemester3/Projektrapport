...
I dette afsnit vil kun de væsentligste krav blive præsenteret. Ønskes der et større indblik i beskrivelse af krav og yderligere krav til projektet henvises 
der til bilagsrapporten. Usecasen som er blevet udevalgt her er "Planlæg åbning", da den også indeholde alt hvad der er i usecasen "Åbn nu". 
"Åbn nu" usecasen kan findes under bilag x, i doukumentationen. Der er yderligere en usecase som ikke er blevet medtaget i denne rapport. 
Det er Usecasen "Indstil tid". Denne er ikke blevet medtaget, da den ikke har den store påvirkning på iltåbningsprocessen.
...
\section(Design og Implementering)
	\subsection(Software)
		\subsubsection(SPI forbindelse)
		\subsubsection(PSoC sensor- og motorstyring)
		\subsubsection(GUI)
	\subsection(Hardware)
